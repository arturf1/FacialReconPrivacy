...
\copyrightnotice{978-1-4673-7454-5/15/\$31.00 {\copyright}2015 Crown}

%For papers in which all authors are employed by the European Union, the copyright notice is:
\copyrightnotice{978-1-4673-7454-5/15/\$31.00 {\copyright}2015 European Union}
...
\name{
\begin{tabular}{ccc}
Author 1, Author 2\sthanks{Thanks to XYZ agency for funding.} & Author 3, Author 4\sthanks{Thanks to XYZ agency for funding.} & Author 5, Author 6\sthanks{Thanks to XYZ agency for funding.}\\
\end{tabular}
}
\address{
\begin{tabular}{ccc}
Address institution 1 &  Address institution 2 & Address institution 3 \\
City 1, Country 1 & City 2, Country 2 &  City 3, Country 3 \\
...
Select one of the four copyright notices below and put in the text field below the first column (only required for the camera paper submission). Most authors should use Copyright notice 4.
...
For papers in which all authors are employed by a Crown government (UK, Canada, and Australia), the copyright notice is:\\
{978-1-4673-7454-5/15/\$31.00 {\copyright}2015 Crown}
\\[2ex]
\noindent{\bf Copyright notice 3:}\\
For papers in which all authors are employed by the European Union, the copyright notice is:\\
{978-1-4673-7454-5/15/\$31.00 {\copyright}2015 European Union}
\\[2ex]
\noindent{\bf Copyright notice 4:}\\
For all other papers the copyright notice is:\\
{978-1-4673-7454-5/15/\$31.00 {\copyright}2015 IEEE}
